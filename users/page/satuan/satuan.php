...
<div class="container-fluid">
    <div class="bg-dashboard">
        <h1 class="mt-4 mb-4"><i class="fas fa-database"></i> Data Satuan</h1>
    </div>

    <div class="card mb-4 shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="fas fa-info-circle"></i> Data Satuan</h5>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-sm" id="dataTable" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $sql = $conn->query("select * from satuan");
                        ...
                        ?>
                            <tr>
                                ...
                                <td data-label="Aksi">
                                    <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#formModal-edit<?php echo $data['id_satuan']; ?>" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    
                                    <a href="javascript:void(0);" class="btn btn-danger btn-xs" onclick="hapusSatuan('<?php echo $data['id_satuan']; ?>')" title="Hapus">
                                        <i class="fas fa-trash"></i>
                                    </a>
                                </td>
                                <?php require 'editsatuan.php'; ?>
                            </tr>
                        <?php } ?>
                    </tbody>
                    
                </table>
                <?php require 'tambahsatuan.php' ?>
            </div>
        </div>
    </div>
</div>
    ...
    function hapusSatuan(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '?page=satuan&aksi=hapussatuan&id=' + id;
            }
        });
    }
</script>