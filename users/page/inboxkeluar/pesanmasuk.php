...
<div class="container-fluid">
    <div class="bg-dashboard">
        <h1 class="mt-4 mb-4"><i class="fas fa-database"></i>Permintaan Barang Keluar</h1>
        <button onclick="terimaSemua()" class="btn btn-success btn-sm mb-3">✅ Terima Semua</button>
    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="page/inboxkeluar/pesanmasuk.php?selesai=${idList.join(',')}" class="btn btn-success btn-sm mr-2">✅ Terima</a>
                                    <a href="page/inboxkeluar/pesanmasuk.php?ditolak=${idList.join(',')}" class="btn btn-danger btn-sm">❌ Tolak</a>
                                </div>
                                <div class="col-md-6">
