<style>
    ...
    @media (max-width: 767.98px) {
        ...
        /* Style untuk tanggal */
        #dataTable td[data-label="Tanggal Keluar"] {
            background: #f0f9ff;
            color: #0369a1;
        }
...
<div class="container-fluid">
    <div class="bg-dashboard">
        <h1 class="mt-4 mb-4"><i class="fas fa-file"></i> Laporan Barang Keluar</h1>
    </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        tampilkanBtn.addEventListener("click", () => {
            ...
            fetch(`page/laporan/get_transaksi_barang_keluar.php?bulan=${bulan}&tahun=${tahun}`)
                ...
                .then(data => {
                    ...
                    data.forEach(transaction => {
                        if (!groupedData[transaction.kode_keluar]) {
                            groupedData[transaction.kode_keluar] = {
                                kode_keluar: transaction.kode_keluar,
                                items: []
                            };
                        }
                        transaction.items.forEach(item => {
                            groupedData[transaction.kode_keluar].items.push({
                    ...
                    Object.values(groupedData).forEach(group => {
                        let rowContent = `
                            <tr>
                                ...
                                <td data-label="Kode Transaksi" rowspan="${group.items.length}">
                                    <a href="page/barangkeluar/detail.php?kode=${group.kode_keluar}">
                                        ${group.kode_keluar}
                                    </a>
                                </td>
                        `;
                        ...
                        group.items.forEach((item, index) => {
                            ...
                            rowContent += `
                                ...
                                <td data-label="Tanggal Keluar">${item.tanggal_keluar}</td>
    ...
    function customPrint() {
        ...
        const judulLaporan = `Laporan Barang Keluar - ${bulanNama[bulan]} ${tahun}`;
        ...
        printWindow.document.write(`
            ...
            <head>
                ...
                <style>
                    ...
                    .kop img { max-width: 80px; display: block; margin: 0 auto 10px; }
                    .kop h1 { font-size: 20px; margin: 0; font-weight: bold; }
                    .kop h2 { font-size: 16px; margin: 0; font-weight: normal; }
