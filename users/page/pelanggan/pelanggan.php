<style>
    ...
    @media (max-width: 767.98px) {
        ...
        /* Nama Pelanggan di bagian atas dengan style khusus */
        #dataTable td[data-label="Nama Pelanggan"] {
            background: #f8fafc;
        ...
        #dataTable td[data-label="Nama Pelanggan"]::before {
            display: none;
        }
        ...
        /* Style untuk alamat dan telepon */
...
<div class="container-fluid">
    <div class="bg-dashboard">
        <h1 class="mt-4 mb-4"><i class="fas fa-database"></i> Data Pelanggan</h1>
    </div>
    
    <div class="card mb-4 shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="fas fa-info-circle"></i> Data Pelanggan</h5>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td data-label="Nama Pelanggan" style="color:#2980b9; font-weight: 600;">
                                    <?php echo htmlspecialchars($data['nama_pelanggan']); ?>
                                </td>
                                <td data-label="Alamat"><?php echo htmlspecialchars($data['alamat']); ?></td>
                                <td data-label="Telepon"><?php echo htmlspecialchars($data['no_telepon']); ?></td>
                                <td data-label="Aksi">
                                    <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#formModal-edit<?php echo $data['id_pelanggan']; ?>" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <a href="javascript:void(0);" class="btn btn-danger btn-xs" onclick="hapusPelanggan('<?php echo $data['id_pelanggan']; ?>')" title="Hapus">
                                        <i class="fas fa-trash"></i>
                                    </a>
                                </td>
                                <?php require 'editpelanggan.php'; ?>
                            </tr>
                        <?php } ?>
                        
                    </tbody>
                </table>
                <?php require 'tambahpelanggan.php'; ?>
            </div>
        </div>
    </div>
</div>
    ...
    function hapusPelanggan(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '?page=pelanggan&aksi=hapuspelanggan&id=' + id;
            }
        });
    }
</script>