<style>
    ...
    @media (max-width: 767.98px) {
        ...
        /* Username di bagian atas dengan style khusus */
        #dataTable td[data-label="Username"] {
            background: #f8fafc;
        ...
        #dataTable td[data-label="Username"]::before {
            display: none;
        }

        /* Badge untuk Role */
        #dataTable td[data-label="Role"] .badge-info {
            background: #10b981;
            color: #065f46;
            padding: 6px 12px;
            border-radius: 20px;
        ...
        #dataTable td[data-label="Nama Lengkap"]::before,
        #dataTable td[data-label="Role"]::before,
        #dataTable td[data-label="Password"]::before {
            color: #6b7280;
            font-weight: 500;
        }
        ...
        /* Style untuk nama lengkap */
        #dataTable td[data-label="Nama Lengkap"] {
            font-weight: 500;
            color: #374151;
        }

        /* Style untuk password */
        #dataTable td[data-label="Password"] {
            color: #6b7280;
...
<div class="container-fluid">
    <div class="bg-dashboard">
        <h1 class="mt-4 mb-4"><i class="fas fa-users"></i> Data User</h1>
    </div>
    
    <div class="card mb-4 shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="fas fa-info-circle"></i> Data User</h5>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td data-label="Username" style="color:#2980b9; font-weight: 600;">
                                    <?php echo $data['username']; ?>
                                </td>
                                <td data-label="Nama Lengkap"><?php echo htmlspecialchars($data['nama_lengkap']); ?></td>
                                <td data-label="Role">
                                    <span class="badge-info"><?php echo htmlspecialchars($data['role']); ?></span>
                                </td>
                                <td data-label="Password"><?php echo htmlspecialchars($data['password']); ?></td>
                                <td data-label="Aksi">
                                    <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#formModal-edit<?php echo $data['id_user']; ?>" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <a href="javascript:void(0);" class="btn btn-danger btn-xs" onclick="hapusUser('<?php echo $data['id_user']; ?>')" title="Hapus">
    ...
    function hapusUser(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '?page=user&aksi=hapususer&id=' + id;
            }
        });
    }
</script>