<style>
    ...
    @media (max-width: 767.98px) {
        ...
        /* Nama Barang di bagian atas dengan style khusus */
        #dataTable td[data-label="Nama Barang"] {
            background: #f8fafc;
        ...
        /* Style untuk stok badge */
        #dataTable td[data-label="Stok"] .badge {
            padding: 6px 12px;
            border-radius: 20px;
            font-size: 0.75rem;
            font-weight: 600;
...
<div class="container-fluid">
    <div class="bg-dasboard">
        <h1 class="mt-4 mb-4"><i class="fas fa-box"></i> Data Barang</h1>
    </div>

    <!-- Data Tables -->
    <div class="card mb-4 shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="fas fa-info-circle"></i> Data Barang</h5>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td data-label="Nama Barang" style="color:#2980b9; font-weight: 600;">
                                ...
                                <td data-label="Stok">
                                    <span class="badge <?php
                                                        if ($data['stok'] == 0) {
                                                            echo 'badge-danger text-white'; // merah
                                                        } elseif ($data['stok'] <= 10) {
                                                            echo 'badge-warning text-dark'; // kuning
                                                        } else {
                                                            echo 'badge-success text-white'; // hijau
                                                        }
                                                        ?>">
                                        <?php echo $data['stok']; ?>
                                    </span>
                                </td>
                                <td data-label="Satuan"><?php echo $data['satuan']; ?></td>
                                
                                <td data-label="Aksi">
                                    <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#formModal-edit<?php echo $data['id_barang']; ?>" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    

                                    <a href="#" class="btn btn-danger btn-sm" onclick="confirmHapus('<?php echo $data['id_barang']; ?>')" title="Hapus">
                                        <i class="fas fa-trash"></i>
                                    </a>
                                </td>
                                <?php require 'editdata.php'; ?>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
                <?php require 'tambahdata.php'; ?>
            </div>
        </div>
    </div>
</div>
    ...
    function confirmHapus(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = `?page=databarang&aksi=hapusbarang&id=${id}`;
            }
        });
    }
</script>